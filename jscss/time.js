function showTime() { 
	...
	var startDate = new Date(2015, 9, 31,19);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear Qing:<br>"
		+ "Our formal love has been:<br> "
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----Hakim "+currentDate+"</c>"; 
